# Contributing to glyvis

This outlines how to propose a change to glyvis. For a detailed
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("glycoverse/glyvis", fork = TRUE)`.
...
Please note that the glyvis project is released with a [Contributor Code
of Conduct](https://glycoverse.github.io/glyvis/dev/CODE_OF_CONDUCT.md).
